export default function WijPage() {
  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      <a
        href={phoneLink}
        className="fixed bottom-6 right-24 z-50 w-16 h-16 rounded-full flex items-center justify-center text-3xl hover:scale-110 transition-transform shadow-lg"
      ...
      <header className="sticky top-0 z-40 bg-white shadow-sm" style={{ backgroundColor: '#bdeffc', height: '80px' }}>
        <div className="max-w-6xl mx-auto px-4 h-full flex justify-between items-center">
          ...
          <nav className="hidden md:flex gap-8 text-sm font-medium" style={{ color: '#3b696d' }}>
            ...
            <a href="/wij" className="hover:opacity-70 font-bold">Wij</a>
