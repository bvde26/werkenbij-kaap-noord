      ...
      <header className="sticky top-0 z-[200]" style={{ backgroundColor: '#bdeffc' }}>
        <div className="px-5 md:px-8 h-[48px] md:h-[64px] flex items-center">
          <Link href="/" className="mr-auto hover:opacity-80 transition-opacity" style={{ display: 'flex', alignItems: 'center', gap: 'clamp(8px, 1.5vw, 14px)', textDecoration: 'none' }}>
            <img src="/logo-header.svg" alt="" className="h-[36px] md:h-[48px] w-auto" aria-hidden="true" />
            <span style={{ fontFamily: "'Pana Summer', serif", fontWeight: 400, fontSize: 'clamp(1.4rem, 2.8vw, 1.75rem)', color: '#3b696d', letterSpacing: '0.04em', lineHeight: 1, display: 'block', paddingTop: '0.15em' }}>
              Kaap Noord
            </span>
          </Link>
          <button
          ...
          >
            {open ? (
              <svg className="h-[26px] md:h-[32px] w-auto" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5" strokeLinecap="round" aria-hidden="true">
                <path d="M18 6L6 18M6 6l12 12" />
              </svg>
            ) : (
              <svg className="h-[26px] md:h-[32px] w-auto" viewBox="0 0 28 22" fill="none" stroke="currentColor" strokeWidth="2.5" strokeLinecap="round" aria-hidden="true">
